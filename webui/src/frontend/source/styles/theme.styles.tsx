...
export const THEME: DefaultTheme = {
    colors: {
        ...
        element: {
            fg: COLOR_PALETTE.colored.main[2],
            bg: COLOR_PALETTE.colored.main[5],
            popoutBg: COLOR_PALETTE.colored.main[4],
            headerBg: COLOR_PALETTE.colored.main[9],
            footerBg: COLOR_PALETTE.colored.main[9],
            normal: COLOR_PALETTE.thematic[3],
            hover: COLOR_PALETTE.colored.main[2],
            pressed: COLOR_PALETTE.colored.main[4],
            overlay: COLOR_PALETTE.colored.main[4],
        },
        button: {
            normal: COLOR_PALETTE.thematic[3],
            hover: COLOR_PALETTE.colored.main[2],
            pressed: COLOR_PALETTE.colored.main[4],
            disabled: COLOR_PALETTE.colored.main[4],
        },
        //Purely Colored
        main: {
